...
class MusicPage{
  ...
  MusicPage({required this.imageMusic1, required this.color1, required this.color2,required this.color3,required this.color4, required this.enstrumanNameMusic,required this.enstrumanfileMusic});

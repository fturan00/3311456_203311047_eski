        ...
        children: [
          Container(
            ...
            child: ImageFiltered(
              ...
              child: Image.asset("images/bateri2.jpg"),
            ),
          ),
          IconButton(
            onPressed: () {
                ...
                child: Column(
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      child: CircleAvatar(
                        radius: 50,
                        backgroundColor: Color.fromARGB(255, 11, 45, 126),
                        child: CircleAvatar(
                          radius: 45,
                          backgroundImage: AssetImage("images/bateri2.jpg"),
                        ),
                      ),
                    ),
                    SizedBox(
